...
mod test {
    ...
    //     guesses.push(Guess {
    //         code: Code(WHITE, WHITE, WHITE, RED),
    //         response: Response { right: 0, wrong: 0 },
    //     });

    //     guesses.push(Guess {
    //         code: Code(WHITE, WHITE, WHITE, BLUE),
    //         response: Response { right: 0, wrong: 1 },
    //     });

    //     // let guesses = Guesses(vec![
    //     //     Guess {
    //     //         code: Code(WHITE, WHITE, WHITE, RED),
    //     //         response: Response { right: 0, wrong: 0 },
    //     //     },
    ...
    //     assert!(guesses.could_match(Code(BLACK, BLUE, BLACK, BLACK)));
    //     assert!(!guesses.could_match(Code(BLACK, BLUE, BLACK, BLUE)));
    // }
    ...
    //     let guess2 = Guess {
    //         code: Code(RED, RED, RED, RED),
    //         response: Response { right: 2, wrong: 0 },
    //     };

    //     let guesses = Guesses(vec![guess1, guess2]);

    //     assert!(!guesses.could_match(Code(BLACK, BLUE, BLACK, BLACK)));
    //     assert!(guesses.could_match(Code(RED, GREEN, BLUE, RED)));
    // }
    ...
    //     let _ = guesses.possible_secrets();
    // }
}
